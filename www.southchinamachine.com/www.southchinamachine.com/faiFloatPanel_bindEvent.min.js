Site.bindEventToFloatPanel = function(d) {
  var at = d, aj = true, ar, A, z = Fai.top._panelOptionData.allowedStyle || (top._templateType != Fai.top._panelOptionData.templateType_free), aC = !Fai.top._panelOptionData.allowedStyle && (top._templateType == Fai.top._panelOptionData.templateType_free), aV = 1, al = "#000", aK = "#000", ay = "#000", q = "#000", ac = "#000", c = "#000", t = "#000", Z = "#000", aq = "#000", aL = "#000", h = "#000", ao = 0;
  function T(a0) {
  ...
  Fai.top.panelFunc.changeContentPaddingValue = function() {
    var aY, a1, a3 = $(".J_contentPaddingSet"), a4 = a3.find(".J_top"), aZ = parseInt(a4.val()), a2 = a3.find(".J_bottom"), a0 = parseInt(a2.val());
    aY = Site.getWebBackgroundData(),
      a1 = aY.cp || (aY.cp = {
        y: 0
      });
  ...
  function aE() {
    ...
    var aY, aZ, a1 = $(".J_contentPaddingSet"), a2 = a1.find(".J_top"), a0 = a1.find(".J_bottom");
    aY = Site.getWebBackgroundData(),
      aZ = aY.cp || (aY.cp = {
        y: 0
      }),
      topVal = aZ.t || (aZ.t = 0),
      bottomVal = aZ.b || (aZ.b = 0);
    if (aZ.y == 1) {
...
function addLayoutModuleAjax(h, c, e, g, j) {
  var d = "ajax/module_h.jsp?cmd=add&style=" + h + "&colId=" + e + "&extId=" + g, f = [], a, b, k;
