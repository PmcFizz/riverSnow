...
window.FAI_HAWK_EYE.sdk_version = 1.1;
window.FAI_HAWK_EYE.FAI_HAWK_EYE_REPORT_URL = window.FAI_HAWK_EYE.jssdk_report_url;
window.devicePixelRatio = window.devicePixelRatio || window.webkitDevicePixelRatio || window.mozDevicePixelRatio || 1;
(function(a, b) {
    a._DEF = {
      _MODULE: {
        _TYPE: {
...
(function(a, b) {
    ...
    a._TOOL._getElementPath = function(c) {
      ...
      } while ((c.nodeName.toLowerCase() != "html") && (c = c.parentNode));return d.join(" > ")
    }
    ;
    ...
    ;
    a._TOOL._getDevicePixelRatio = function() {
    ...
    ;
    a._TOOL._getPageReferrer = function() {
      try {
        if (!!window.Fai && !!window.Fai.top && !!window.Fai.top.document) {
          return window.Fai.top.document.referrer
        } else {
...
(function(g) {
    ...
    function f() {
      var i = {};
      var j = document.URL;
      var k = g._TOOL._getPageReferrer();
    ...
    function e() {
      var l = {};
      var k = g._TOOL._getLang();
      var i = g._TOOL._getScreenSize();
      var j = g._TOOL._getDevicePixelRatio();
      l[g._DEF._REPORT._CLIENT._CLI_LANG] = k;
      l[g._DEF._REPORT._CLIENT._CLI_SCREEN_TYPE] = i;
      l[g._DEF._REPORT._CLIENT._CLI_DPR] = j;
      return l
    }
    var d = a();
    var b = f();
    ...
    g._DATA[g._DEF._REPORT._CLIENT._CLI_DPR] = h[g._DEF._REPORT._CLIENT._CLI_DPR]
  }
)(window.FAI_HAWK_EYE);
(function(e, k, c) {
    ...
    function f(l, m) {
      ...
      function n() {
        ...
        if (!!e.performance && !!e.performance.timing) {
          var o, x, t, q, v, u, w, p, r = null;
          o = performance.timing;
          x = o.domainLookupEnd - o.domainLookupStart;
          t = o.connectEnd - o.connectStart;
          q = o.responseEnd - o.requestStart;
          response_time = o.responseStart - o.navigationStart;
          v = o.domComplete - o.domInteractive;
          u = o.domInteractive - o.navigationStart;
          w = o.domComplete - o.navigationStart;
          p = o.domContentLoadedEventEnd - o.navigationStart;
          r = o.loadEventEnd - o.navigationStart;
          s[k._DEF._REPORT._PERFORMANCE._DOMAIN_LOOKUP_TIME] = x;
          s[k._DEF._REPORT._PERFORMANCE._TCP_TIME] = t;
          s[k._DEF._REPORT._PERFORMANCE._REQUEST_TIME] = q;
          s[k._DEF._REPORT._PERFORMANCE._BACK_END_TIME] = response_time;
          s[k._DEF._REPORT._PERFORMANCE._DOM_PARSE_TIME] = v;
          s[k._DEF._REPORT._PERFORMANCE._WRITER_SCREEN_TIME] = u;
          s[k._DEF._REPORT._PERFORMANCE._FIRST_SCREEN_TIME] = w;
          s[k._DEF._REPORT._PERFORMANCE._DOM_READY_TIME] = p;
          s[k._DEF._REPORT._PERFORMANCE._FINISH_TIME] = r
        }
        return s
      }
    }
    ...
    function b(l, m) {
      ...
      this._init = function() {
        ...
        function n(v) {
          ...
          w[k._DEF._REPORT._CLICK._STEP_PV] = o._step_pv;
          o.report(w, o._type)
        }
      }
    }
    ...
    function d(p, q) {
      ...
      this._init = function() {
        var v = this;
        var u = ((k.jssdk_appid == 3010) && (Math.random(1) * 10 <= 5));
        var t = ((k.jssdk_appid == 6001) && (Math.random(1) * 10 <= 2));
        var s = ((k.jssdk_appid == 5002) && (Math.random(1) * 10 <= 1));
        if (false) {
          if (!!e.addEventListener) {
      ...
      function l() {
        ...
        s.push(v);
        v = {};
        v.url = "//t1.faisco.cn/tsu.gif?t=" + t;
        v.type = 1;
        v.size = 51200;
        s.push(v);
        v = {};
        v.url = "//t2.faisco.cn/tsu.gif?t=" + t;
        v.type = 1;
        v.size = 51200;
        s.push(v);
        return s
