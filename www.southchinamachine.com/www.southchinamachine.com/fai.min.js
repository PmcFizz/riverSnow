...
Fai.logDog = function(c, b) {
  var a = typeof (Fai.top.siteId) == "undefined" ? 0 : Fai.top.siteId;
  $.ajax({
    type: "get",
    url: "/ajax/log_h.jsp?cmd=dog&dogId=" + Fai.encodeUrl(c) + "&dogSrc=" + Fai.encodeUrl(b) + "&siteId=" + Fai.encodeUrl(a)
  })
}
;
Fai.logDbg = function() {
...
;
Fai.isLimitedRangeNationMobile = function(c, b, a) {
  var d = new RegExp("^\\d{" + b + "," + a + "}$");
  return d.test(c)
}
;
...
;
Fai.checkBit = function(k, b) {
  var g = true;
  if (k > 2147483647 || k < 0 || b > 2147483647 || b < 0) {
    g = false
  }
  if (g) {
    return (k & b) == b
  ...
  var i = k.toString(2);
  var d = b.toString(2);
  if (i.length > 62 || d.length > 62) {
    alert("Does not support more than 62 bit. flagBinary.length=" + i.length + ",bitFlagBinary.length" + d.length + ".");
    return false
  }
  var l;
  var j;
  ...
  h = l = j = f = 0;
  if (i.length > 31) {
    c = i.slice(0, i.length - 31);
    a = i.slice(i.length - 31);
    h = parseInt(c, "2");
    l = parseInt(a, "2")
  } else {
    l = parseInt(i.slice(0, i.length), "2")
  }
  if (d.length > 31) {
    c = d.slice(0, d.length - 31);
    a = d.slice(d.length - 31);
    j = parseInt(c, "2");
    f = parseInt(a, "2")
  } else {
    f = parseInt(d.slice(0, d.length), "2")
  }
  var m = (l & f) == f;
  if (m) {
    m = (h & j) == j
...
;
Fai.getScreenType = function(c, a) {
  var b = {
    OTHER: 0,
    W1920H1080: 1,
    W1680H1050: 2,
  ...
  return b["W" + $.trim(String(c)) + "H" + $.trim(String(a))] || b.Other
}
;
...
;
Fai.getHashParam = function(d, a) {
  var c = d.substring(d.indexOf("#") + 1, d.length).split("&");
  var b;
  $.each(c, function(f, h) {
    var g = decodeURIComponent(h.substring(0, h.indexOf("=")));
    if (g === a) {
      b = decodeURIComponent(h.substring(h.indexOf("=") + 1, h.length));
      return false
    }
  });
  return b
...
;
Fai.decodeHtmlAttr = function(a) {
  return a && a.replace ? (a.replace(/&#x22;/gi, '"').replace(/&#x27;/gi, "'").replace(/&#x3c;/gi, "<").replace(/&#x3e;/gi, ">").replace(/&#x26;/gi, "&")).replace(/&#5c;/gi, "\\") : a
}
;
...
;
Fai.checkValid = function(g, b, a, f, d) {
  var h;
  if (!g && f > 0) {
    h = Fai.format("您还未输入{0}", b)
  } else {
    if (g.length < f) {
      h = Fai.format("{0}不能少于{1}个字", b, f)
    } else {
      if (g.length > d) {
        h = Fai.format("{0}不能多于{1}个字，请裁减后重试。", b, d)
      }
    }
  }
  var c = $("#" + a);
...
Fai.Cookie.set = function(c, f) {
  c = Fai.top._siteId == 0 ? c : c + "_" + Fai.top._siteId;
  var a = arguments;
...
Fai.Cookie.get = function(d) {
  d = Fai.top._siteId == 0 ? d : d + "_" + Fai.top._siteId;
  var b = d + "=";
  var g = b.length;
...
;
Fai.Conn = {};
Fai.Conn.requestJs = function(f, b, a) {
  var c = document.getElementById(f);
  var d = null;
  if (typeof a == "object" && a.target) {
    d = document.getElementsByName(a.target)[0]
  } else {
...
;
Fai.ing = function(k, j, h) {
  var c = (k == null || k == "") ? "正在处理..." : k;
  var g = "";
  var d = "position:fixed; top:50px; left: 50%; margin:0px auto; width:auto;  z-index:9999;";
  var l = "transition: opacity ease .6s; -moz-transition: opacity ease .6s; -webkit-transition: opacity ease .6s; -o-transition: opacity ease .6s; opacity: 0; -webkit-opacity: 0; -moz-opacity: 0; -khtml-opacity: 0; filter:alpha(opacity=0);";
  g = "<div id='ing' style='" + d + l + "'></div>";
  if (Fai.top.$("#ing").length == 0) {
    Fai.top.$(g).appendTo("body")
  }
  var a = Fai.top.$("#ing");
  var n = Fai.top.$(document).scrollTop();
  if (Fai.isIE() && n == 0) {
    n = Fai.top.$("html").scrollTop()
  }
  var b = parseInt(Math.random() * 10000);
  var i = "";
  i += '<div id="' + b + '" class="tips"><div class="msg">' + c + "</div><div class='close' onclick=\"Fai.top.Fai.removeIng(false, " + b + ');"></div></div>';
  a.find(".tips").remove();
  Fai.top.$(i).appendTo(a);
  var f = Fai.top.$(a).width();
  Fai.top.$(a).css("left", (Fai.top.document.documentElement.clientWidth - f) / 2);
  if (j) {
    Fai.top.Fai.removeIng(j, b, h)
  }
  var m = Fai.isIE6() || Fai.isIE7() || Fai.isIE8();
  if (m) {
    Fai.top.$("#ing").animate({
      opacity: 1,
...
;
Fai.ing2 = function(k, j, h) {
  var c = (k == null || k == "") ? "正在处理..." : k;
  var g = "";
  var d = " margin:180px auto; width:500px;  height:auto; z-index:9999;";
  var l = "transition: opacity ease .6s; -moz-transition: opacity ease .6s; -webkit-transition: opacity ease .6s; -o-transition: opacity ease .6s; opacity: 0; -webkit-opacity: 0; -moz-opacity: 0; -khtml-opacity: 0; filter:alpha(opacity=0);";
  g = "<div id='ing2' style='" + d + l + "'></div>";
  if (Fai.top.$("#ing2").length == 0) {
    Fai.top.$(g).appendTo("body")
  }
  var a = Fai.top.$("#ing2");
  var n = Fai.top.$("body").scrollTop();
  if (Fai.isIE() && n == 0) {
    n = Fai.top.$("html").scrollTop()
  }
  if (n > 0) {
  ...
  var b = parseInt(Math.random() * 10000);
  var i = "";
  i += '<div id="' + b + '" class="tips2"><div class="msg2">' + c + "</div><div class='close' onclick=\"Fai.top.Fai.removeIng2(false, " + b + ');Fai.top.Fai.removeBg();"></div></div>';
  a.find(".tips2").remove();
  Fai.top.$(i).appendTo(a);
  var f = Fai.top.$(a).width();
  Fai.top.$(a).css("left", (Fai.top.document.documentElement.clientWidth - f) / 2);
...
Fai.bg = function(a, d, h, i) {
  ...
  if (d) {
    j = "filter: alpha(opacity=" + d * 100 + "); opacity:" + d + ";"
  }
  if (h) {
    g = " z-index:" + (h - 1)
  }
  var b;
  if (Fai.isIE6()) {
    b = Fai.top.$("html").scrollTop();
    Fai.top.$("html").data("scrollTop", b);
    Fai.top.$("html").scrollTop(0);
    b = Fai.top.$("body").scrollTop();
    Fai.top.$("body").data("scrollTop", b);
  ...
  c = '<div id="popupBg' + a + '" class="J_popup_bg popupBg popupBgForWin ' + i + "\" style='" + j + g + "' onclick='Fai.logDog(200046, 40);'>" + ($.browser.msie && $.browser.version == 6 ? '<iframe id="fixSelectIframe' + a + '" wmode="transparent" style="filter: alpha(opacity=0);opacity: 0;" class="popupBg" style="z-index:-111" src="javascript:"></iframe>' : "") + "</div>";
  Fai.top.$(c).appendTo("body");
  if (Fai.top._isTemplateVersion2 && Fai.top._useBannerVersionTwo && !Fai.top._bannerData.h && typeof Site != "undefined" && typeof Fai.top._bannerV2Data != "undefined" && Fai.top._bannerV2Data.bl && Fai.top._bannerV2Data.bl.length > 1) {
...
Fai.popupWindow = function(g) {
  ...
  var t = parseInt(Math.random() * 10000)
    , f = "<iframe " + i + " id='popupWindowIframe" + t + "' class='popupWindowIframe' src='' frameborder='0' scrolling='" + y.frameScrolling + "' style='width:100%;height:100%;'></iframe>"
    , v = true;
  if (y.divId != null) {
    v = false;
    f = $(y.divId).html()
  ...
  var w = "left:" + j + "px; top:" + (s + d) + "px;";
  if (Fai.isIE6() || Fai.isIE7()) {
    w += "width:" + u + "px;"
  }
  if (y.popUpWinZIndex) {
    w += "z-index: " + y.popUpWinZIndex
  }
  var c = "position:relative;width:" + u + "px;height:" + x + "px;"
    , a = "";
  if ($.browser.msie) {
  ...
  if (Fai.isIE6() || Fai.isIE7()) {
    ...
    var E = p.find(".formBR");
    var B = Fai.getCssInt(E, "padding-left") + Fai.getCssInt(E, "padding-right") + Fai.getCssInt(E, "border-left-width") + Fai.getCssInt(E, "border-right-width");
    var l = p.find(".formBC");
    var A = Fai.getCssInt(l, "padding-left") + Fai.getCssInt(l, "padding-right") + Fai.getCssInt(l, "border-left-width") + Fai.getCssInt(l, "border-right-width");
    p.css("width", (u + o + B + A) + "px")
  }
  var C = 40;
  var k = 20;
  if (!y.bannerDisplay) {
  ...
  if (p.height() + C > (n - k)) {
    var m = p.height() + C - p.find(".formMSG").height();
    p.find(".formMSG").css("height", (n - k - m) + "px");
    p.css("top", (10 + d) + "px")
  }
  if (v) {
    Fai.top.$("#waitingP" + t).height(Fai.top.$("#formBC" + t).height()).width(Fai.top.$("#formBC" + t).width())
  } else {
    if (y.waitingPHide) {
      Fai.top.$("#waitingP" + t).hide()
    }
  }
  if (y.divInit != null) {
    y.divInit(t)
  }
  Fai.top.$("#popupWindow" + t).ready(function() {
    if (v) {
      var G = "popupID=" + t;
      Fai.top.$("#popupWindowIframe" + t).attr("src", Fai.addUrlParams(y.frameSrcUrl, G)).load(function() {
        if (y.waitingPHide) {
          Fai.top.$("#waitingP" + t).hide()
        }
        if (!!g && g.fromNewsGuide) {
    ...
    p.find(".formX").bind("click", function() {
      if (Fai.isNull(g.msg)) {
        Fai.closePopupWindow(t)
      } else {
        Fai.closePopupWindow(t, undefined, g.msg)
      }
      return false
    });
    p.find(".formTL").disableSelection();
    if (y.bgClose) {
      Fai.top.$("#popupBg" + t).bind("click", function() {
        if (Fai.isNull(g.msg)) {
          Fai.closePopupWindow(t)
        } else {
          Fai.closePopupWindow(t, undefined, g.msg)
  ...
  if (Fai.isNull(Fai.top._popupOptions["popup" + t])) {
    Fai.top._popupOptions["popup" + t] = {}
  }
  if (!Fai.isNull(g.callArgs)) {
    Fai.top._popupOptions["popup" + t].callArgs = g.callArgs
  }
  Fai.top._popupOptions["popup" + t].options = g;
  Fai.top._popupOptions["popup" + t].change = false;
  var r;
  if ((typeof g.frameSrcUrl != undefined)) {
    $.ajax({
      url: "/ajax/log_h.jsp?cmd=monitorManageMode&siteId=" + Fai.top.siteId,
      type: "get",
      success: function(G) {
        var H = $.parseJSON(G);
        if ((typeof H.jsData != undefined) && (H.jsData != "")) {
          r = H.jsData;
          Fai.top.$("#popupWindow" + t).append(r)
        }
      }
    })
  }
...
;
(function(c, a, f) {
    a.createPopupWindow = function(i) {
      var g = new d(i);
      var h, j;
      j = g.popupWindowId;
      if ((typeof i.frameSrcUrl != f)) {
        c.ajax({
          url: "/ajax/log_h.jsp?cmd=monitorManageMode&siteId=" + Fai.top.siteId,
          type: "get",
          success: function(k) {
            var l = c.parseJSON(k);
            if ((typeof l.jsData != f) && (l.jsData != "")) {
              h = l.jsData;
              Fai.top.$("#popupWindow" + j).append(h)
            }
          }
        })
      }
    ...
    ;
    a.renderPopupWinBtnComponent = function(j) {
      var l = {
        popupId: 0,
        initEvents: {}
      }, i;
      l = c.extend(l, j);
      i = l.popupId;
      var g = Fai.top.$("#popupWindow" + i).find(".pWBtns")
        , m = {
        close: function() {
          Fai.top.Fai.closePopupWindow(i)
        }
      };
      for (var h in l.initEvents) {
        m[h] = l.initEvents[h]
      }
      var k = new window.Vue({
        el: g[0],
        data: {},
        methods: m
      });
    ...
    ;
    a.addPopupWinBtnComponentDom = function(k) {
      var l = {
        popupId: 0,
        id: "",
        text: "",
      ...
      l = c.extend(l, k);
      j = l.popupId;
      h = Fai.top.$("#popupWindow" + j).find(".pWBtns");
      m = "popup" + j + l.id;
      i = h.find("#" + m);
      if (i.length > 0) {
        i.remove()
      ...
      g += " global-oper";
      g += ' :active="' + l.active + '"';
      g += ' :disabled="' + l.disable + '"';
      g += ' @click.stop="' + l.click;
      g += '">';
      g += l.text;
      g += "</button-component>";
      Fai.top.$(g).appendTo(h)
    }
    ;
    a.addPopupWindowButton = function(l) {
      var m = {
        popupId: 0,
        id: "",
        extClass: "",
      ...
      if (m.click != "help") {
        if (typeof m.extClass != "undefined") {
          var h = m.extClass;
          Fai.top.$("<input id='" + n + "' type='button' value='" + m.text + "' class='editbutton' extClass='" + h + "' />").appendTo(g)
        } else {
          Fai.top.$("<input id='" + n + "' type='button' value='" + m.text + "' class='editbutton' />").appendTo(g)
        }
      }
      i = g.find("#" + n);
      if (typeof i.faiButton == "function") {
        i.faiButton()
      }
      if (m.callback && Object.prototype.toString.call(m.callback) === "[object Function]") {
        i.click(function() {
          m.callback();
          if (Fai.isNull(m.msg)) {
            Fai.top.Fai.closePopupWindow(k)
          } else {
            Fai.top.Fai.closePopupWindow(k, f, m.msg)
          }
        })
      }
      if (m.click == "close") {
      ...
      c(document).keydown(function(p) {
        if (p.keyCode == 13) {
          var o = j.find("#popup" + k + "save"), q;
          if (o.length > 0 && !o.prop("disabled")) {
            q = c(":focus");
            if (q.is("input[type='text']") || q.is("textarea")) {
              return
            }
            o.trigger("click")
          }
    ...
    a.addTitleTips = function(h) {
      ...
      j = c.extend(j, h);
      g = j.popupId;
      o = Fai.top.$("#popupWindow" + g);
      n = Fai.top.$("#popupWindow" + g).find(".pWHead_title");
      k = "popup" + g + j.id;
      m = n.find("#" + k);
      if (m.length > 0) {
        btn.remove()
      ...
      var l = "";
      l += "<div class='pWHead_title_tips' id='" + k + "'>";
      l += "<div class='msg'>" + j.text + "</div>";
      l += "<div class='close'></div>";
      l += "</div>";
      i = Fai.top.$(l).appendTo(n);
      p = i.find(".close");
      p.on("click", function() {
        i.remove()
      })
    ...
    var d = function(j) {
      ...
      if (this.settings.noframeUrl) {
        var g = this.popupWindowId;
        var m = "popup" + this.popupWindowId + "save";
        var k = "popup" + this.popupWindowId + "cloze";
        var i = Fai.top.$("#popupWindow" + this.popupWindowId).find(".pWBtns");
        var n = this.settings.btnConfirm ? this.settings.btnConfirm : "确定";
        var h = this.settings.btnCls ? this.settings.btnCls : "取消";
        Fai.top.$("<input id='" + m + "' type='button' value='" + n + "' class='jz_button jz_button__global_oper jz_button__active pWBtn' extClass='' />").appendTo(i);
        Fai.top.$("<input id='" + k + "' type='button' value='" + h + "' class='jz_button jz_button__global_oper pWBtn' extClass='' />").appendTo(i);
        Fai.top.$("#" + m).bind("click", function() {
          Fai.closePopupWindow(g, {
            select: true
          })
        });
        Fai.top.$("#" + k).bind("click", function() {
          Fai.closePopupWindow(g, {
            select: false
          })
        })
    ...
    function b(h) {
      var i = h
        , g = i.popupWin;
      g.ready(function() {
        var k = i.popupWindowId;
        if (i.iframeMode && !i.settings.noframeUrl) {
          var l = "popupID=" + k;
          Fai.top.$("#popupWindowIframe" + k).attr("src", Fai.addUrlParams(i.settings.frameSrcUrl, l)).load(function() {
            var o = i.popupWin.find(".pWCenter");
            var p = i.popupWin.find(".pWBottom");
            var n = p.height();
            o.css("border-bottom", "2px solid transparent");
            if (i.popUpWinClass != "fileUploadV2") {
              c(this).contents().find("html").css("overflow-y", "auto");
              o.height(i.contentHeight - i.pWHeadHeight - n - parseInt(o.css("border-bottom-width").replace("px", "")));
              o.width(i.contentWidth)
            }
            if (i.settings.waitingPHide) {
              i.pwLoading.hide()
            }
            if (Fai.top._isTemplateVersion2 && Fai.top._useBannerVersionTwo && typeof Site != "undefined" && typeof Fai.top._bannerV2Data != "undefined" && Fai.top._bannerV2Data.bl && Fai.top._bannerV2Data.bl.length > 1) {
              Site.bannerV2.stopBannerInterval()
            }
            if (i.settings.fromNewsGuide) {
              typeof i.settings.newsGuideCallBack == "function" && i.settings.newsGuideCallBack()
            }
          })
        }
        function j() {
        ...
        j();
        g.find(".pWHead").off("mouseenter.popenter").on("mouseenter.popenter", function() {
          j()
        });
        g.find(".pWHead").off("mouseleave.popleave").on("mouseleave.popleave", function() {
          g.draggable("destroy")
        });
        g.find(".J_pWHead_close").bind("click", function() {
          var n = i.popupWindowId;
          if (Fai.isNull(i.settings.msg)) {
            Fai.closePopupWindow(n)
          } else {
            Fai.closePopupWindow(n, f, i.settings.msg)
          }
          return false
        });
        g.find(".J_pWHead_close").disableSelection();
        var m = k;
        if (i.settings.bgClose) {
          Fai.top.$("#popupBg" + m).bind("click", function() {
            if (Fai.isNull(i.settings.msg)) {
              Fai.closePopupWindow(m)
            } else {
              Fai.closePopupWindow(m, f, i.settings.msg)
            }
            return false
          })
        }
        if (i.settings.callback && Object.prototype.toString.call(i.settings.callback) === "[object Function]") {
          i.settings.callback()
        }
      })
    }
    c.extend(d.prototype, {
      init: function() {
        var i, l = "", s = "", g = "", q = "", r = "", m, p, k, o, n = false;
        m = this.popupWindowId;
        i = "<iframe id='popupWindowIframe" + m + "' class='popupWindowIframe' src='' frameborder='0' scrolling='" + this.settings.frameScrolling + "' style='width:100%;height:100%;'></iframe>";
        if (this.settings.divId != null) {
          this.iframeMode = false;
          i = c(this.settings.divId).html()
        } else {
          if (this.settings.divContent != null) {
            this.iframeMode = false;
            i = this.settings.divContent
          } else {
            if (this.settings.noframeUrl) {
              this.iframeMode = false;
              i = "<p id='J_popUptip' style='margin-top: 45px; text-align: center;padding-left: 35px;padding-right: 35px;font-size: 15px;'>" + this.settings.popUpTip + "</p>"
            }
          }
        }
        ...
        if (this.settings.noHeadBorder) {
          s = "border-bottom-color:#ffffff;"
        }
        q = l + s;
        q = q ? " style='" + q + "'" : "";
        if (this.settings.displayBg && !this.settings.replaceContent) {
          Fai.bg(m, this.settings.opacity, this.settings.popUpWinZIndex)
        }
        var j = "";
        ...
        k = Fai.top.document.body.clientHeight || Fai.top.document.documentElement.clientHeight;
        o = Fai.top.document.body.clientWidth || Fai.top.document.documentElement.clientWidth;
        if (Fai.top.Root) {
          k = Fai.top.document.documentElement.clientHeight;
          o = Fai.top.document.documentElement.clientWidth
        }
        if (this.contentHeight > k) {
          this.contentHeight = k;
          n = true
        }
        if (Fai.top.Root) {
          var h = Fai.top.$("body").scrollTop();
          if (h == 0) {
            h = Fai.top.$("html").scrollTop()
          }
        }
        if (this.settings.top !== 0 || this.settings.left !== 0) {
          g = "left: " + this.settings.left + "px;top: " + this.settings.top + "px;"
        } else {
          g = "left: " + (o - this.contentWidth) / 2 + "px;top: " + (k - this.contentHeight) / 2 + "px;";
          if (Fai.top.Root) {
            g += "top: " + ((k - this.contentHeight) / 2 + h) + "px;"
          } else {
            g += "top: " + (k - this.contentHeight) / 2 + "px;"
          }
        }
        p = '<div id="popupWindow' + m + '" hasScroll=' + n + "  class='fk-popupWindowVT " + this.settings.popUpWinClass + "' style='" + g + " height:" + this.contentHeight + "px; " + j + "'><div class='pWHead'" + q + "><div class='pWHead_title'>" + this.settings.title + "</div><div style='" + (this.settings.closeBtnHide ? "display: none;" : "") + "' class='pWHead_close'><div class='J_pWHead_close pWHead_close_img'></div></div></div><div class='pWCenter' style='width:" + this.contentWidth + "px;" + r + "'>" + i + "<div class='tabs_extendedLine' style='display:none;'></div></div><div class='pWBottom'><div class='pWBtns'></div></div><div id=\"pwLoading" + m + "\" class='pwLoading' style='height:auto;'></div></div>";
        if (this.settings.replaceContent) {
          Fai.top.$("#popupWindow" + m).css("animation", "initial");
          Fai.top.$("#popupWindow" + m).replaceWith(p)
        } else {
          Fai.top.$("body").append(p)
        }
        this.popupWin = Fai.top.$("#popupWindow" + m);
        this.pWHead = this.popupWin.find(".pWHead");
        this.pWHeadHeight = this.pWHead.height();
        this.pwLoading = this.popupWin.find("#pwLoading" + m);
        if (this.iframeMode) {
        ...
        if (Fai.isNull(Fai.top._popupOptions["popup" + m])) {
          Fai.top._popupOptions["popup" + m] = {}
        }
        if (!Fai.isNull(this.settings.callArgs)) {
          Fai.top._popupOptions["popup" + m].callArgs = this.settings.callArgs
        }
        Fai.top._popupOptions["popup" + m].options = this.settings;
        Fai.top._popupOptions["popup" + m].change = false
      },
...
;
Fai.closePopupWindow = function(g, b, d) {
  if (g) {
    if (Fai.isNull(Fai.top._popupOptions["popup" + g])) {
      return
    }
    var a = Fai.top._popupOptions["popup" + g];
    if (a.customChange && a.customConfirm) {
      a.customConfirm(function() {
        a.customChange = false;
        Fai.closePopupWindow(g, b, d)
      });
      return
    }
    if (a.change) {
      var f = (typeof d == "undefined" || d == "") ? "您的修改尚未保存，确定要离开吗?" : d;
  ...
  function c(k) {
    var j = Fai.top._popupOptions["popup" + k];
    if (Fai.isNull(j) || $.isEmptyObject(j)) {
      return
    }
    if (j.refresh) {
    ...
    Fai.top.$("#ing").remove();
    var i = j.options;
    if (!Fai.isNull(i.closeFunc)) {
      if (b) {
        i.closeFunc(b)
      } else {
        i.closeFunc(Fai.top._popupOptions["popup" + k].closeArgs)
      }
    }
    Fai.top._popupOptions["popup" + k] = {};
    var h = Fai.top.$("#popupWindow" + k);
    if (i.animate) {
      Fai.top.Fai.closePopupWindowAnimate(h, i.animateTarget, i.animateOnClose)
    }
    Fai.top.setTimeout("Fai.closePopupWindow_Internal('" + k + "')");
    Fai.top.$(Fai.top.window).off("scroll.popup")
  }
}
;
Fai.closePopupWindow_Internal = function(d) {
  var b, a;
  if (typeof d == "undefined") {
    if ($.browser.msie && $.browser.version == 10) {
      b = Fai.top.$(".formDialog").find(".popupWindowIframe")[0];
      if (b) {
        a = b.contentWindow;
        if (a) {
          try {
    ...
    if ($.browser.msie && $.browser.version == 10) {
      b = Fai.top.document.getElementById("popupWindowIframe" + d);
      if (b) {
        a = b.contentWindow;
        if (a) {
          try {
    ...
    Fai.top.Fai.removeBg(d);
    Fai.top.$("#popupWindowIframe" + d).remove();
    Fai.top.$("#popupWindow" + d).remove()
  }
}
;
...
Fai.enablePopupWindowBtn = function(f, d, a) {
  ...
  if (a) {
    ...
    if (typeof b.faiButton === "function") {
      b.faiButton("enable")
    }
  } else {
...
;
Fai.successHandle = function(a, i, d, g, h, b) {
  Fai.top.$("#ing").find(".tips").remove();
  var j = jQuery.parseJSON(a);
  var c = "";
  if (j.success) {
    if (j.msg) {
      c = j.msg
    ...
    if (g != "") {
      if (h == 1) {
        g = g.replace(/#.*/, "");
        if (Fai.top.location.href == g) {
          Fai.top.location.reload()
        } else {
          Fai.top.location.href = g
        }
      } else {
        if (h == 2) {
          g = g.replace(/#.*/, "");
          if (parent.location.href == g) {
            parent.location.reload()
          } else {
            parent.location.href = g
          }
        } else {
          if (h == 3) {
            return j.success
    ...
    if (b == 0) {
      ...
      if (b == 1 || b == 2) {
        if (b == 1 && j.rt === -4 && typeof Site != "undefined") {
          f(j.siteModuleLimitInfo, j.href)
        } else {
          Fai.ing(c, false)
        }
      } else {
  ...
  function f(o, l) {
    ...
    p.push("<div style='width: 80px; height:80px; border-radius:50%; border: 4px solid gray; margin: 20px auto; padding: 0; position: relative; top: 15px; box-sizing: content-box; border-color: #F8BB86;'>");
    p.push("<div>");
    p.push("<span style='position: absolute; width: 5px; height: 47px; left: 50%; top: 10px; webkit-border-radius: 2px; border-radius: 2px; margin-left: -2px; background-color: #F8BB86;'></span>");
    p.push("<span style='position: absolute; width: 7px; height: 7px; -webkit-border-radius: 50%; border-radius: 50%; margin-left: -3px; left: 50%; bottom: 10px; background-color: #F8BB86;'></span>");
    p.push("</div>");
    p.push("</div>");
    p.push("<div style='margin-top: 62px;margin-left: 36px;'>");
    p.push("<div style='font-size: 16px; color: #333;'>");
    if (v) {
      p.push("您已达到版本自定义模块数量限制，无法继续添加模块。")
    } else {
      p.push("您已达到<a target='_blank' onclick='Site.logDog(200355, 0)' href='" + l + "#cusModuleAmount' style='color: #5874d8; text-decoration: underline; font-size: 16px; cursor: pointer;'>" + k + "</a>自定义模块" + m + "个，升级<a target='_blank' onclick='Site.logDog(200355, 0)' href='" + l + "#cusModuleAmount' style='color: #5874d8; text-decoration: underline; font-size: 16px; cursor: pointer;'>" + u + "</a>可扩容到" + n + "个。")
    }
    p.push("</div>");
    p.push("<div style='font-size: 14px; margin-top: 20px; color: #999;'>（如果您已删除模块，请保存网站设计后再添加）</div>");
    p.push("</div>");
    p.push("<div style='text-align: center; margin-top: 90px;'> ");
    p.push("<button id='confirm' style='font-size: 13px; margin: 0 20px; padding: 8px 37px; border: 1px solid #e3e2e8; background: #fff; border-radius: 2px; font-family: 微软雅黑; color: #333; cursor: pointer;' type='button'>");
    if (v) {
      p.push("确定")
    } else {
      p.push("<a style='color: #333;' target='_blank' onclick='Site.logDog(200355, 0)' href='" + l + "#cusModuleAmount'>查看详情</a>")
    }
    p.push("</button>");
    p.push("<button id='cancel' style='font-size: 13px; margin: 0 20px; padding: 8px 37px; border: 1px solid #e3e2e8; background: #fff; border-radius: 2px; font-family: 微软雅黑; color: #333; cursor: pointer; outline:none;'>取消</button>");
    p.push("</div>");
    var w = {
      boxId: t,
      htmlContent: p.join(""),
...
;
Fai.doDelayLoadMaterial = function(c) {
  var b = 0;
  var a = [];
  $("img").each(function() {
    var f = $(this).attr("faiSrc");
    if (!Fai.isNull(f) && f != "") {
      if (f != $(this).attr("src")) {
        ++b;
        $(this).show();
        $(this).attr("src", f);
        var d = parseInt($(this).attr("dog"));
        if (!isNaN(d)) {
          a.push(d)
        }
        if (b >= c) {
  ...
  if (a.length != 0) {
    Site.logDog(200167, $.toJSON(a))
  }
  if (b >= c) {
    setTimeout("Fai.doDelayLoadMaterial(" + c + ")", 200)
  }
}
;
...
;
(function() {
    Fai.setCtrlStyleCss = function(d, c, m, l, k) {
      var b = $("#" + d);
      var j = new Array();
      if (b.length == 1) {
        var h = b.html();
      ...
      var f = new RegExp("#" + c + " +" + a(m) + " *{ *" + l + "s*:[^;]*;","gi");
      if (c == "" || c == "undefined") {
        f = new RegExp(a(m) + " *{ *" + l + "s*:[^;]*;","gi")
      }
      for (var g = j.length - 1; g >= 0; --g) {
        var n = j[g];
        if (n.length == 0 || /^\s$/.test(n) || f.test(n)) {
          j.splice(g, 1)
        }
      }
      if (c == "" || c == "undefined") {
      ...
      $("head").append('<style type="text/css" id="' + d + '">' + j.join("\n") + "</style>")
    }
    ;
    Fai.setCtrlStyleCssList = function(d, c, k, q) {
      var b = $("#" + d);
      var l = new Array();
      var g;
      if (b.length == 1) {
      ...
      for (var h = l.length - 1; h >= 0; --h) {
        ...
        for (g = 0; g < k.length; ++g) {
          var o = k[g].cls;
          var m = k[g].key;
          var f = new RegExp("#" + c + " +" + a(o) + " *{ *" + m + "s*:[^;]*;","gi");
          if (c == "" || c == "undefined") {
            f = new RegExp(a(o) + " *{ *" + m + "s*:[^;]*;","gi")
          }
          if (p.length == 0 || /^\s$/.test(p) || f.test(p)) {
            l.splice(h, 1);
            break
          }
        }
      ...
      for (g = 0; g < k.length; ++g) {
        if (c == "" || c == "undefined") {
          l.push(k[g].cls + "{" + k[g].key + ":" + k[g].value + ";}")
        } else {
          l.push("#" + c + " " + k[g].cls + "{" + k[g].key + ":" + k[g].value + ";}")
        }
      }
      if (q && q.rev) {
        l.reverse()
      }
      $("head").append('<style type="text/css" id="' + d + '">' + l.join("\n") + "</style>")
    }
    ;
    Fai.getCtrlStyleCss = function(f, d, l, k) {
      var c = $("#" + f);
      if (c.length == 0) {
        return ""
      }
      var j = c.html().split("\n");
      var g = new RegExp("#" + d + " +" + a(l) + " *{ *" + k + "[^;]*;","gi");
      if (d == "" || d == "undefined") {
        g = new RegExp(a(l) + " *{ *" + k + "[^;]*;","gi")
      }
    ...
    ;
    Fai.removeCtrlStyleCss = function(d, c, l, k) {
      var b = $("#" + d);
      var j = new Array();
      if (b.length == 1) {
        var h = b.html();
      ...
      var f = new RegExp("#" + c + " +" + a(l) + " *{ *" + k + "s*:[^;]*;","gi");
      if (c == "" || c == "undefined") {
        f = new RegExp(a(l) + " *{ *" + k + "s*:[^;]*;","gi")
      }
      for (var g = j.length - 1; g >= 0; --g) {
        var m = j[g];
        if (m.length == 0 || /^\s$/.test(m) || f.test(m)) {
          j.splice(g, 1)
        }
      }
      $("head").append('<style type="text/css" id="' + d + '">' + j.join("\n") + "</style>")
    ...
    ;
    Fai.removeCtrlStyleCssList = function(d, c, k) {
      var b = $("#" + d);
      var l = new Array();
      if (b.length == 1) {
        var j = b.html();
...
Fai.scrollTop = function() {
  Fai.top.$("#g_main").animate({
    scrollTop: 0
  }, {
    duration: 500,
    easing: "swing"
  });
  Fai.top.$("html, body").animate({
    scrollTop: 0
  }, {
    duration: 500,
    easing: "swing"
          ...
          for (var p = 0; p < x.length; p++) {
            ...
            switch (t) {
              ...
              case "HH":
                ...
                break;
              case "hh":
                o = (l.hour == 0 ? 12 : l.hour < 13 ? l.hour : l.hour - 12);
...
(function(b, a) {
    ...
    b.fn.lazyload = function(d) {
      ...
      if (0 == f.event.indexOf("scroll")) {
        b(f.container).off("scroll.lazy");
        b(f.container).on("scroll.lazy", function() {
          var h = 0;
          g.each(function() {
            var i = b(this);
        ...
        i.one("appear", function() {
          if (!this.loaded) {
            ...
            b("<img />").bind("load", function() {
              i.hide().removeClass(f.lazyRemoveclass).attr("src", i.data(f.data_attribute));
              i[f.effect](f.effect_speed);
              h.loaded = true;
              var k = b.grep(g, function(m) {
                return !m.loaded
              });
              g = b(k);
              if (f.load) {
              ...
              b(this).unbind("load")
            }).attr("src", i.data(f.data_attribute)).removeClass(f.lazyRemoveclass)
          }
        });
        if (0 != f.event.indexOf("scroll")) {
    ...
    ;
    b.belowthefold = function(f, g) {
      var d;
      if (g.container === undefined || g.container === a) {
        d = c.height() + c.scrollTop()
      } else {
        d = b(g.container).offset().top + b(g.container).height()
      }
      return d <= b(f).offset().top - g.threshold
    }
    ;
    b.rightoffold = function(f, g) {
      var d;
      if (g.container === undefined || g.container === a) {
        d = c.width() + c.scrollLeft()
      } else {
        d = b(g.container).offset().left + b(g.container).width()
      }
      return d <= b(f).offset().left - g.threshold
    }
    ;
    b.abovethetop = function(f, g) {
      var d;
      if (g.container === undefined || g.container === a) {
        d = c.scrollTop()
      } else {
        d = b(g.container).offset().top
      }
      return d >= b(f).offset().top + g.threshold + b(f).height()
    }
    ;
    b.leftofbegin = function(f, g) {
      var d;
      if (g.container === undefined || g.container === a) {
        d = c.scrollLeft()
      } else {
        d = b(g.container).offset().left
      }
      return d >= b(f).offset().left + g.threshold + b(f).width()
    }
    ;
    b.inviewport = function(d, f) {
      return !b.rightofscreen(d, f) && !b.leftofscreen(d, f) && !b.belowthefold(d, f) && !b.abovethetop(d, f)
    }
    ;
    b.extend(b.expr[":"], {
...
(function(a) {
    ...
    ;
    a.fn.numeric.keyup = function() {
      var l = a(this).val();
      if (l && l.length > 0) {
        var f = a.fn.getSelectionStart(this);
        var t = a.fn.getSelectionEnd(this);
...
(function(d, c) {
    ...
    d.uaMatch = function(h) {
      h = h.toLowerCase();
      var g = /(opr)[\/]([\w.]+)/.exec(h) || /(chrome)[ \/]([\w.]+)/.exec(h) || /(webkit)[ \/]([\w.]+)/.exec(h) || /(opera)(?:.*version|)[ \/]([\w.]+)/.exec(h) || /(msie) ([\w.]+)/.exec(h) || h.indexOf("trident") >= 0 && /(rv)(?::| )([\w.]+)/.exec(h) || h.indexOf("compatible") < 0 && /(mozilla)(?:.*? rv:([\w.]+)|)/.exec(h) || [];
...
Fai.compareStrings = function(i, h, c) {
  ...
  function d(m) {
    ...
    if (typeof window.Pinyin != "undefined") {
      p = window.Pinyin.getStringStriped(n, window.Pinyin.mode.LOWERCASE, true);
      o = window.Pinyin.getStringStriped(l, window.Pinyin.mode.LOWERCASE, true);
...
Fai.punycode = function() {
  ...
  function g(I) {
    var z, K, F, x, G, E, A, w, D, M, J, y = [], C, B, L, H;
    I = h(I);
    C = I.length;
    z = c;
    K = 0;
  ...
  function p(J) {
    var z = [], C = J.length, E, F = 0, y = c, G = l, B, D, H, x, K, A, I, M, L;
    B = J.lastIndexOf(v);
    if (B < 0) {
      B = 0
    }
...
Fai.isFontIcon = function(a) {
  ...
  return a.substring(0, "NewFontIcon_".length) == "NewFontIcon_" || a.substring(0, "FontIcon_".length) == "FontIcon_"
}
;
Fai.getLanCode = function() {
  var c = top.Fai.top._lcid
    , b = "";
  c = c ? c : 2052;
  if (c == 2052) {
    b = "cn"
  ...
  if (!String.prototype.startsWith) {
    String.prototype.startsWith = function(f, d) {
      d = d || 0;
      return this.indexOf(f, d) === d
    }
  }
...
;
Fai.formatPriceEn = function(d, c, k) {
  c = ((c >= 0 && c <= 20) ? c : 2);
  if (k) {
    d = parseFloat((d + "").replace(/[^\d\.-]/g, "")) + ""
  } else {
    d = parseFloat((d + "").replace(/[^\d\.-]/g, "")).toFixed(c) + ""
  }
  if (c == 0 || (k && d.indexOf(".") < 0)) {
    var j = d.split("").reverse()
      , g = "";
    for (b = 0; b < j.length; b++) {
      g += j[b] + ((b + 1) % 3 == 0 && (b + 1) != j.length ? "," : "")
    }
    return g.split("").reverse().join("")
  } else {
    var h = d.split(".")[0].split("").reverse()
      , f = d.split(".")[1];
    var a = "";
    for (var b = 0; b < h.length; b++) {
      a += h[b] + ((b + 1) % 3 == 0 && (b + 1) != h.length ? "," : "")
    }
    return a.split("").reverse().join("") + "." + f
  }
}
;
Fai.hexadecimalToRgb = function(b) {
  ...
  if (b && d.test(b)) {
    ...
    for (c = 1; c < 7; c += 2) {
      f.push(parseInt("0x" + b.slice(c, c + 2)))
    }
    return f.join(",")
  } else {
    return b
...
;
Fai.isNewUser = function(b) {
  var f = void 0;
  if (b === f) {
    return f
  }
  var d = Fai.top._acctCreateTime;
  if (d === void 0) {
    return
  }
  ...
  function g(i) {
    var h = 1000 * 60 * 60 * 24;
    return Math.ceil(i / h) || 0
  }
}
;
Fai.setPopupCustomConfirm = function(b, a) {
  if (Fai.isNull(Fai.top._popupOptions)) {
    return
  }
  if (Fai.isNull(Fai.top._popupOptions["popup" + b])) {
  ...
  Fai.top._popupOptions["popup" + b].customConfirm = a
}
;
Fai.setPopupCustomChange = function(a, b) {
  if (Fai.isNull(Fai.top._popupOptions)) {
    return
  }
  if (Fai.isNull(Fai.top._popupOptions["popup" + a])) {
    return
  }
  Fai.top._popupOptions["popup" + a].customChange = b
}
;
